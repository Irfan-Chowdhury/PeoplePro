...
<div id="documenter_sidebar">
    <img src="{{ asset('docs/assets/images/logo.png')}}" style="border: none;margin: 0 10px -10px;width: 40px">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        const attendanceDeviceURL = baseUrl + '/docs-attendance-device-addon'
