                        ...
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table  table-bordered">
                                    ...
                                    <tr>
                                        <th>{{__('Candidate Info')}}</th>
                                        <td id="candidate_info"></td>
                                    </tr>

                                    <tr>
                                        <th>{{__('Candidate Email')}}</th>
                                        <td id="candidate_email"></td>
                                    </tr>
            ...
            $(document).on('click', '.details', function () {
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        $('#candidate_info').html(result.data.full_name + '<br><h6> Fb: '+ result.data.fb_id + '</h6><h6> Linkedin: '+result.data.linkedin_id+'</h6>');
                        $('#candidate_email').html(result.data.email);
