...
<?php $__env->startSection('content'); ?>
    ...
    <?php if(!$bugNotificationEnable): ?>
        <section id="noBug" class="container mt-5 text-center">
            <div class="card">
                <div class="card-body">
                    <?php if(session()->has('bugUpdated') && session()->get('bugUpdated')==='success'): ?>
...
<script>
    ...
    let bugUpdateURL          = "<?php echo e(route('bug-update')); ?>";
    let redirectURL           = "<?php echo e(route('bug-update-page')); ?>";
</script>
...
<script type="text/javascript" src="<?php echo e(asset('js/admin/bug_update/index.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/peoplepro/resources/views/bug_update/index.blade.php ENDPATH**/ ?>