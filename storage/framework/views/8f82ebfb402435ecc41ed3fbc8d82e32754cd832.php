    ...
    <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
            <ul id="side-main-menu" class="side-menu list-unstyled">
                <?php if(auth()->user()->role_users_id ==1): ?>
                    <li><a href="<?php echo e(url('/admin/dashboard')); ?>"> <i class="dripicons-meter"></i><span>Dashboard</span></a>
                    </li>
                <?php else: ?>
                    <li><a href="<?php echo e(url('/employee/dashboard')); ?>"> <i class="dripicons-meter"></i><span>Dashboard</span></a>
                    </li>
                <?php endif; ?>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('customize-setting')): ?>
                    <li><a href="#Customize_settings" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-toggles"></i><span><?php echo e(__('Customize Setting')); ?></span></a>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('core_hr')): ?>
                    <li><a href="#Core_hr" aria-expanded="false" data-toggle="collapse"> <i
                                    class="dripicons-briefcase"></i><span><?php echo e(__('Core HR')); ?></span></a>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-calendar')): ?>
                    <li><a href="<?php echo e(route('calendar.index')); ?>"> <i
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('event-meeting')): ?>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-ticket')): ?>
                        <li><a href="<?php echo e(route('tickets.index')); ?>"> <i
...
</html><?php /**PATH C:\xampp\htdocs\Lion-Coders\peoplepro\resources\views/vendor/translation/layout.blade.php ENDPATH**/ ?>