    ...
    <section>
        ...
        <div class="card animated fadeInRight mr-5 ml-5">
            ...
            <div class="card-body">
                ...
                <p class="card-text">The correct column order is (First Name, Last Name, Username, <?php echo e(trans('file.Email')); ?>, Password,Date
                    of Joining, Gender, Date of Birth, Contact Number, Address) and you must follow the csv file,
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Lion-Coders\peoplepro\resources\views/employee/import.blade.php ENDPATH**/ ?>