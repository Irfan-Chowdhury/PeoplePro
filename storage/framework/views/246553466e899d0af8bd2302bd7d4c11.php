<div class="tab-pane fade" id="bugUpdateSetting" role="tabpanel" aria-labelledby="bug-update-setting">
    <div class="card">
        <h4 class="card-header p-3"><b><?php echo app('translator')->get('file.Bug Setting'); ?></b></h4>
        <hr>
        <div class="card-body">
            <form action="<?php echo e(route('admin.bug-update-setting.submit')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group row">
                    <div class="col-sm-8">
                        <div class="filesArea">
                            <?php if(isset($bugSettings->files)): ?>
                                <?php $__currentLoopData = $bugSettings->files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="row">
                ...
                <div class="form-group row">
                    <div class="col-sm-8">
                        <div class="logArea">
                            <?php if(isset($bugSettings->logs)): ?>
                                <?php $__currentLoopData = $bugSettings->logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="row">
                                        <div class="col-8 form-group">
...
<?php /**PATH /var/www/html/peoplepro/peoplepro_org/resources/views/developer_section/bug_update_setting.blade.php ENDPATH**/ ?>