        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-9 col-md-10 mb-3">
                    <h4 class="font-weight-bold"><?php echo e($client->name); ?> <span class="text-muted">(<?php echo e($user->username); ?>)</span>
                    </h4>
...
<?php echo $__env->make('layout.client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Lion_Coders\Peoplepro\Running_File\peoplepro\resources\views/dashboard/client_dashboard.blade.php ENDPATH**/ ?>