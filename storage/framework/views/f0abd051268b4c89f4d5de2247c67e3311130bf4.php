...
<div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="createModalLabel" aria-hidden="true">
        ...
        <div class="modal-body">
            <form action="" method="POST">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-6">
                          <select name="designation_id" id="designation_id" class="form-control selectpicker dynamic"
                                    data-live-search="true" data-live-search-style="begins"
                                    data-first_name="first_name" data-last_name="last_name"
                                    title='<?php echo e(__('Selecting',['key'=>trans('file.Company')])); ?>'>
                                    <option value="">HARSALE</option>
                  ...
                  <div class="row">
                      <div class="col-md-6">
                          ...
                          <div class="form-group row">
                              <label for="inputEmail3" class="col-sm-6 col-form-label"><b>Customer Experience</b></label>
                              <div class="col-sm-6">
  ...
  </div><?php /**PATH C:\xampp\htdocs\Lion-Coders\PeoplePro-Related\peoplepro\resources\views/performance/indicator/create-modal.blade.php ENDPATH**/ ?>