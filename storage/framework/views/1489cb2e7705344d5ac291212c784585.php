	...
	<div class="col-md-6 offset-md-3">
		<div class='wrapper'>
		    ...
		    <div class="content">
		        ...
		        ?>
		        <form action="<?php echo e(url('/saas-install/process')); ?>" method="post">
                    <?php echo csrf_field(); ?>
		            <fieldset>
...
<?php /**PATH /var/www/html/peoplepro/peoplepro_testsaas/resources/views/addons/saas/step_3.blade.php ENDPATH**/ ?>