                    ...
                    <div class="modal-body">
                        ...
                        <form method="get" id="payment_form" class="form-horizontal" >
                               <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="name"><?php echo e(__('Monthly Payslip')); ?></label>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Lion-Coders\Peoplepro\Running_File\peoplepro\resources\views/salary/pay_list/index.blade.php ENDPATH**/ ?>