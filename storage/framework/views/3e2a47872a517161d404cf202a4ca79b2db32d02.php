                    ...
                    <div class="card">
                        ...
                        <div class="container">
                            <?php if($user->profile_photo): ?>
                                <td> <img src="<?php echo e(url('public/uploads/profile_photos',$user->profile_photo)); ?>" height="120" width="120">
                                </td>
                            <?php else: ?>
                                <td> <img src="<?php echo e(url('public/logo/avatar.jpg')); ?>" height="120" width="120" >
                                </td>
                            <?php endif; ?>
                        </div>
...
<?php echo $__env->make('layout.client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Lion_Coders\Peoplepro\Running_File\peoplepro\resources\views/profile/client_profile.blade.php ENDPATH**/ ?>