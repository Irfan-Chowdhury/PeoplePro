...
<div class="modal fade" id="EditformModal" tabindex="-1" role="dialog" aria-labelledby="createModalLabel" aria-hidden="true">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">        
                    <select name="company_id" id="companyIdEdit" class="form-control selectpicker dynamic" data-live-search="true" data-live-search-style="begins"
                        data-dependent="designation_name" title='<?php echo e(__('Selecting',['key'=>trans('file.Company')])); ?>...'>
  ...
  <script>
    ...
    //     if (companyIdEdit){
    //         $.get("<?php echo e(route('performance.indicator.get-designation-by-company')); ?>",{companyIdEdit:companyIdEdit}, function (data){
    //             console.log(data);
    //             $('#designationIdEdit').empty().html(data);
    //         });
    //     }else{
    //         $('#designationIdEdit').empty().html('<option>Select Designation</option>');
    //     }
    // })
...
</script><?php /**PATH D:\xampp\htdocs\Lion_Coders\10.01.2020\peoplepro\resources\views/performance/indicator/edit-modal-test.blade.php ENDPATH**/ ?>