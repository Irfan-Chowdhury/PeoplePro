                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="company_id" id="company_id"
                                                                ...
                                                                <?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option value="<?php echo e($company->id); ?>" <?php echo e(($employee->company_id === $company->id) ? "selected" : ''); ?>><?php echo e($company->company_name); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <select name="department_id" id="department_id"
                                                                ...
                                                                <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option value="<?php echo e($department->id); ?>"
                                                                            <?php echo e(($department->id === $employee->department_id) ? 'selected':''); ?>><?php echo e($department->department_name); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <select name="designation_id" id="designation_id"
                                                            ...
                                                            <?php $__currentLoopData = $designations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $designation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($designation->id); ?>"
                                                                        <?php echo e(($designation->id === $employee->designation_id) ? 'selected':''); ?>><?php echo e($designation->designation_name); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="status_id" id="status_id"
                                                                ...
                                                                <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option value="<?php echo e($status->id); ?>" <?php echo e(($employee->status_id === $status->id) ? "selected" : ''); ?>><?php echo e($status->status_title); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        ...
                                                        <select name="office_shift_id" id="office_shift_id"
                                                            ...
                                                            <?php $__currentLoopData = $office_shifts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $office_shift): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($office_shift->id); ?>"
                                                                        <?php echo e(($office_shift->id === $employee->office_shift_id) ? 'selected':''); ?>><?php echo e($office_shift->shift_name); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                    </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Lion-Coders\PeoplePro-Related\10.01.2020\peoplepro\resources\views/employee/dashboard.blade.php ENDPATH**/ ?>