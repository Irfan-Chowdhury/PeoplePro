                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            render: function (data) {
                                if (data) {
                                    return "<img class='profile-photo md' src=<?php echo e(URL::to('/public')); ?>/uploads/profile_photos/" + data + "/>";
                                } else {
                                    return "<img class='profile-photo md' src=<?php echo e(URL::to('/public')); ?>/logo/avatar.jpg/>";
                                }
                            },
                            orderable: false
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Lion-Coders\PeoplePro-Related\10.01.2020-with Progress\peoplepro\resources\views/all_user/index.blade.php ENDPATH**/ ?>