                            ...
                            <?php $__currentLoopData = $translationsData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php if(!is_array($value)): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <textarea class="edit_textarea form-control"><?php echo e($value); ?></textarea>
...
<?php $__env->startPush('lang_scripts'); ?>
...
<?php echo $__env->make('translation::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/peoplepro_10/resources/views/vendor/translation/languages/translations/index.blade.php ENDPATH**/ ?>