        ...
        (function ($) {
            ...
            $(document).ready(function () {
                ...
                $('#assigned_form').on('submit', function (event) {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('tickets.assigned',$ticket)); ?>",
                        method: "POST",
            ...
            $('#details_form').on('submit', function (event) {
                ...
                $.ajax({
                    url: "<?php echo e(route('ticket_details.store',$ticket)); ?>",
                    method: "POST",
                    data: new FormData(this),
                    contentType: false,
                    cache: false,
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/peoplepro_10/resources/views/SupportTicket/details.blade.php ENDPATH**/ ?>