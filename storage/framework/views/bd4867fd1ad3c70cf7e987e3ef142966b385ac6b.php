...
<div class="modal fade" id="salary_model" tabindex="-1" role="dialog" aria-labelledby="basicModal"
    ...
    <div class="modal-dialog modal-lg">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card-block">
                            <div id="accordion">
                                <div class="card mb-2">
                                    <div class="card-header"> <a class="text-dark" data-toggle="collapse" href="#monthly_salary" aria-expanded="true"> <strong><?php echo e(__('Monthly Payslip')); ?></strong> </a> </div>
                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive" data-pattern="priority-columns">
                                                <table class="table table-striped table-bordered dataTable no-footer">
                                                    <tbody>
                                                    <tr>
                                                        <td><strong><?php echo e(__('Monthly Payslip')); ?>:</strong> <span class="pull-right" id="basic_salary_amount"></span></td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                            </div>
        ...
        <div class="modal-footer">
            <button type="button" class="payslip-close btn btn-default" data-dismiss="modal"><?php echo e(trans('file.Close')); ?></button>
        </div>
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\Lion-Coders\PeoplePro-Related\10.01.2020\peoplepro\resources\views/employee/payslip/index.blade.php ENDPATH**/ ?>