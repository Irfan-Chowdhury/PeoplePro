        ...
        (function($) {  
            ...
            $(document).ready(function () {
                ...
                let table_table = $('#client_task-table').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "<?php echo e(route('clientTask')); ?>",
                    },
            ...
            $('#sample_form').on('submit', function (event) {
                ...
                $.ajax({
                    url: "<?php echo e(route('clientTask.store')); ?>",
                    method: "POST",
            ...
            $('#edit_sample_form').on('submit', function (event) {
                ...
                $.ajax({
                    url: "<?php echo e(route('clientTask.update')); ?>",
                    method: "POST",
                    data: new FormData(this),
                    contentType: false,
                    cache: false,
            ...
            $(document).on('click', '.edit', function () {
                ...
                let target = "<?php echo e(route('clientTask')); ?>/" + id + '/edit';
...
<?php echo $__env->make('layout.client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Lion_Coders\Peoplepro\Running_File\peoplepro\resources\views/client/task.blade.php ENDPATH**/ ?>