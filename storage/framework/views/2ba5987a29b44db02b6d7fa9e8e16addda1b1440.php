                ...
                <div class="col-9 col-md-10 mb-3">
                    ...
                    <form class="d-inline m1-2" action="<?php echo e(route('employee_attendance.post',$employee->id)); ?>" name="set_clocking"
                        ...
                        <?php if(!$employee_attendance || $employee_attendance->clock_in_out=== 0): ?>
                            <button class="btn btn-success btn-sm" type="submit" id="clock_in_btn"><i class="dripicons-enter"></i> <?php echo e(__('Clock IN')); ?></button>
                        <?php else: ?>
                            <button class="btn btn-danger btn-sm" type="submit" id="clock_out_btn"><i class="dripicons-exit"></i> <?php echo e(__('Clock Out')); ?></button>
                        <?php endif; ?>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Lion-Coders\Peoplepro\Running_File\peoplepro\resources\views/dashboard/employee_dashboard.blade.php ENDPATH**/ ?>