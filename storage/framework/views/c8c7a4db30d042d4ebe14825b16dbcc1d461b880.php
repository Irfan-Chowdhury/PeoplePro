                    ...
                    success: function (result) {
                                    ...
                                    items: [

                                        {
                                            ...
                                            items: [
                                                ...
                                                {
                                                    id: 'timesheet',
                                                    text: '<?php echo e(__('Access TimeSheet')); ?>',
                                                    checked: ($.inArray('timesheet', result) >= 0) ? true : false
                                                },
                        ...
                        $("#treeview2").kendoTreeView({
                            ...
                            dataSource: [
                                ...
                                {
                                    id: 'import-module',
                                    text: "<?php echo e(trans('Import Module')); ?>",
                                    expanded: true,
                        ...
                        $("#treeview3").kendoTreeView({
                            ...
                            dataSource: [
                                ...
                                {
                                    id: 'assign-module',
                                    text: "<?php echo e(trans('Assign Module')); ?>",
                                    expanded: true,
                                ...
                                {
                                    id: 'access-module',
                                    text: "<?php echo e(trans('Access Module')); ?>",
                                    expanded: true,
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Lion_Coders\08.01.2020\peoplepro\resources\views/settings/roles/permission.blade.php ENDPATH**/ ?>