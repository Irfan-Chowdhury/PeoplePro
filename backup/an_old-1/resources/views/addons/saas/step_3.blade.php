	...
	<div class="col-md-6 offset-md-3">
		<div class='wrapper'>
		    ...
		    <div class="content">
		        ...
		        ?>
		        <form action="{{ url('/saas-install/process') }}" method="post">
                    @csrf
		            <fieldset>
						<label>Envato Purchase Code <a href="#purchasecodeModal" role="button" data-toggle="modal">?</a></label>
		                <input type='text' required class="form-control" name="purchasecode">

                        <label>cPanel API Key</label>
		                <input type='text' required class="form-control" name="cpanel_api_key">

                        <label>cPanel User Name</label>
		                <input type='text' required class="form-control" name="cpanel_username">

                        <label>Root Domain</label>
		                <input type='text' required class="form-control" name="central_domain">

                        <label>DB Prefix</label>
		                <input type='text' required class="form-control" name="db_prefix">

                        <label>Database Host (<span class='help-block'>e.g. localhost</span>)</label>
		                <input type='text' required class="form-control" name="db_host">

                        <label>Database Port</label>
		                <input type='number' required class="form-control" name="db_port">

                        <label>Database Username</label>
		                <input type='text' required class="form-control" name="db_username">

                        <label>Database Password</label>
		                <input type='password' required class="form-control" name="db_password">

                        <label>Database Name</label>
		                <input type='text' required class="form-control" name="db_name">
