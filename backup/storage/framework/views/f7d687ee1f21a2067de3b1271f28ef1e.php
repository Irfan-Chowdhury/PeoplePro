    ...
    <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
            <ul id="side-main-menu" class="side-menu list-unstyled">
                ...
                <li class="has-dropdown <?php echo e((request()->is('addons*')) ? 'active' : ''); ?>">
                    <a href="#addons" aria-expanded="false" data-toggle="collapse">
                        <i class="dripicons-archive"></i><span><?php echo e(__('Addons')); ?></span>
                    </a>
                    <ul id="addons" class="collapse list-unstyled ">
                        <li id="files">
                            <a href="<?php echo e(route('saas')); ?>"><?php echo e(__('SaaS')); ?></a>
                        </li>
                    </ul>
                </li>
...
<?php /**PATH /var/www/html/peoplepro/peoplepro_testsaas/resources/views/layout/main_partials/sidebar.blade.php ENDPATH**/ ?>